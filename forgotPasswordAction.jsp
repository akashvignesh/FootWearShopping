...
String mobileNumber=request.getParameter("mobileNumeber");
...
try {
    ...
    while(rs.next()) {
        check=1;
        st.executeUpdate("update users set password '"+newpassword"' where email ='"+email+"' and mobileNumber ='"+mobileNumber+"'");
